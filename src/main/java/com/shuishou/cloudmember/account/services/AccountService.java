...
public class AccountService implements IAccountService {
	...
	public ObjectResult addAccount(long userId, String username, String password, String permission) {
		...
		logger.debug("User " + selfUser + " add user " + user + " account.");
...
//		long lUserId = Long.parseLong(userId);
		...
		logger.debug("User " + operator + " change " + user + "'s password.");
	...
	public ObjectResult modifyAccount(long operateUserId, long userId, String username, String permission) {
		...
		logger.debug("User "+ selfUser + " modify user "+ user + " account information to ( username = "+ username+", permission = "+permission+").");
...
//		userPermissionDA.deleteByUserId(id);
		...
		// write log.
		UserData selfUser = userDA.getUserById(userId);
		logger.debug("User " + selfUser + " remove user " + user + ".");
